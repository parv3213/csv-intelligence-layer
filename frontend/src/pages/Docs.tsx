...
const columnTypes = [
  {
    ...
    description: "Text values, trimmed and normalized",
  },
  {
    name: "integer",
    icon: <Hash className="h-4 w-4" />,
    description: "Whole numbers (e.g., 42, -10, 0)",
  },
  {
    name: "float",
    icon: <Hash className="h-4 w-4" />,
    description: "Decimal numbers (e.g., 3.14, -0.5)",
  },
  {
    name: "boolean",
  ...
  },
  {
    ...
    description: "Email addresses, validated format",
  },
  {
    name: "uuid",
    icon: <Key className="h-4 w-4" />,
    description: "UUID v4 format strings",
  },
  {
    name: "url",
    icon: <LinkIcon className="h-4 w-4" />,
    description: "Valid URL strings",
  },
  {
    name: "json",
    icon: <Braces className="h-4 w-4" />,
    description: "JSON objects or arrays",
  },
];
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <ScrollArea className="w-full whitespace-nowrap">
          <TabsList className="inline-flex w-full sm:w-auto">
            ...
            <TabsTrigger value="schemas" className="flex-shrink-0">
              Schemas
            </TabsTrigger>
            <TabsTrigger value="pipeline" className="flex-shrink-0">
              Pipeline
            </TabsTrigger>
            <TabsTrigger value="examples" className="flex-shrink-0">
              Examples
            </TabsTrigger>
          </TabsList>
        ...
        <TabsContent value="overview" className="space-y-6">
          <Card>
            ...
            <CardContent className="prose prose-gray dark:prose-invert max-w-none">
              <p>
                CSV Intelligence Layer is a{" "}
                <strong>deterministic data transformation pipeline</strong>
                that treats CSV files as "hostile input" and normalizes them
                against a canonical schema.
              </p>
              <p>
                Think of it as a <strong>compiler for messy data</strong>: you
                define what your clean data should look like, and the system
                transforms any CSV to match that specification.
              </p>

              <h3>Core Principles</h3>
              <ul>
                <li>
                  <strong>Schema-driven:</strong> Define your target structure
                  once, then normalize any CSV to match it.
                </li>
                <li>
                  <strong>Deterministic:</strong> Same input, same output, every
                  time. No AI hallucinations or random variations.
                </li>
                <li>
                  <strong>Explainable:</strong> Every transformation is logged
                  and traceable. You can see exactly what changed and why.
                </li>
                <li>
                  <strong>Human-in-the-loop:</strong> When mappings are
                  ambiguous, the system pauses for human review rather than
                  guessing.
                </li>
              </ul>
            </CardContent>
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Link
                  to="/api-docs"
                  className="inline-flex items-center gap-1 text-xs sm:text-sm text-primary mt-4 hover:underline"
                >
                  View full API docs
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Each column in your schema must have a type. The system will
                  attempt to coerce input values to match the target type.
                </p>
                  ...
                  {columnTypes.map((type) => (
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        <code className="text-xs sm:text-sm font-mono font-semibold">
                          {type.name}
                        </code>
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
                  <div className="p-3 border rounded-lg space-y-2">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      If true, rows missing this column's value will be flagged
                      as invalid.
                    </p>
                  ...
                  <div className="p-3 border rounded-lg space-y-2">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      If true, empty/null values are allowed even if required is
                      true.
                    </p>
                    <p className="text-xs text-muted-foreground/70">
                      Default: true
                  ...
                  <div className="p-3 border rounded-lg space-y-2">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      Alternative column names to match (e.g., ["email",
                  ...
                  <div className="p-3 border rounded-lg space-y-2">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      Expected date format for date/datetime columns (e.g.,
                      "MM/dd/yyyy").
                    </p>
                  </div>
                  <div className="p-3 border rounded-lg space-y-2">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      If true, any validation or coercion error in this column
                      will cause the entire row to be rejected, overriding the
                      global error policy.
                    </p>
                    <p className="text-xs text-muted-foreground/70">
                      Default: false
...
{ "type": "maxLength", "value": 50 }`}
                  ...
                  <div className="p-3 border rounded-lg">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      Ensure all values in this column are unique across the
                      dataset.
                    </p>
                    <pre className="mt-2 p-2 bg-muted rounded text-xs overflow-x-auto">
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
                  <div className="p-3 border rounded-lg">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      Include row in output with error markers. Best for
                  ...
                  <div className="p-3 border rounded-lg">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      Exclude rows with validation errors from output. Best for
                  ...
                  <div className="p-3 border rounded-lg">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      Replace invalid values with column defaults. Best when
                  ...
                  <div className="p-3 border rounded-lg">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      Stop processing on first error. Best for critical data
                      imports.
                    </p>
                  </div>
                </div>
        ...
        <TabsContent value="pipeline" className="space-y-6">
            ...
            <CardContent className="space-y-4 sm:space-y-6">
              <div className="flex gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    Auto-detect delimiter (comma, semicolon, tab, pipe). Parse
                    CSV structure and extract headers. Handle encoding detection
                    and malformed rows.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    Sample data to detect column types. Uses voting algorithm
                    across samples to determine type with confidence score.
                    Tracks null ratios and sample values.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    Match source columns to target schema. Tries exact match,
                    case-insensitive, aliases, then fuzzy matching.
                    Low-confidence mappings require human review.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    Apply type coercion to target types. Run validators (regex,
                    min/max, enum). Handle errors according to policy. Track
              ...
              <div className="flex gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    Transform rows to match schema column order. Format dates
                    and normalize values. Generate clean CSV or JSON output
                    ready for download.
                  </p>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-xs sm:text-sm text-muted-foreground mb-4">
                When column mappings are ambiguous (confidence below 80% or
                multiple equally likely matches), the pipeline pauses for human
                review.
              </p>
              <p className="text-xs sm:text-sm text-muted-foreground">
                You'll see the proposed mapping with alternatives, and can
                confirm or override each decision. Once resolved, processing
        ...
        <TabsContent value="examples" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                E-commerce Orders schema with validation
              </CardDescription>
            </CardHeader>
            <CardContent>
